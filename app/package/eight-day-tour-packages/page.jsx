...
const EIGHT_DAY_DATA = [
  {
    id: "cbe-ooty-kodai-8d",
    route: "Coimbatore - Ooty - Kodaikanal - Coimbatore",
    duration: "8 Days / 7 Nights",
    itinerary: {
      day1: "Coonoor: Dolphin Nose, Lamb's Rock, Tea Gardens, Sims Park. Stay in Ooty.",
      day2: "Ooty: Doddabetta Peak, Tea Museum, Botanical Garden, Rose Garden, Ooty Lake, Wax World.",
      day3: "Cine Shooting Point, Pykara Water Falls & Boating, Mudumalai Wildlife. Back to Ooty.",
      day4: "Ooty to Avalanche, Tribal Museum. Back to Ooty.",
      day5: "Proceed to Kodaikanal via Palani Temple visit. Stay at Kodai.",
      day6: "Kodaikanal: Pine Forest, Guna Cave, Green Valley View, Pillar Rock, Coaker's Walk.",
      day7: "Kurinji Andavar Temple, Chettiyar Park, Kodai Lake, Bryant Park, Bear Shola Falls & Local Shopping.",
      day8: "Silver Cascade Falls, Museum, Back to Coimbatore."
    },
    inclusions: "Vehicle Cost, Parking & Toll, Driver Allowance.",
    pricing: [
      { vehicle: "Swift Dzire A/C (Sedan)", price: "26,000" },
      { vehicle: "Toyota Etios A/C (Sedan)", price: "26,000" },
      { vehicle: "Innova A/C (SUV)", price: "35,400" },
      { vehicle: "Innova Crysta A/C", price: "48,700" },
      { vehicle: "Traveller A/C (14-seater)", price: "52,000" }
    ]
  },
  {
    id: "cbe-ooty-munnar-thekkady-alleppey-8d",
    route: "Coimbatore - Ooty - Munnar - Thekkady - Alleppey - Coimbatore",
    duration: "8 Days / 7 Nights",
    itinerary: {
      day1: "Doddabetta Peak, Tea Museum, Botanical Garden, Rose Garden, Ooty Lake, Wax World.",
      day2: "Cine Shooting Point, Pykara Falls & Boating, Mudumalai Wildlife. Back to Ooty.",
      day3: "To Munnar via Coonoor: Dolphin Nose, Lamb's Rock, Sims Park, Tea Gardens. Stay at Munnar.",
      day4: "Munnar: Rose Garden, Photo Point, Honey Tree, Elephant Camp, Mattupatty Dam, Echo Point, Top Station.",
      day5: "Rajamalai Wildlife, Spice Plantation, Local Shopping.",
      day6: "To Thekkady: Periyar Boating, Kerala Cultural Program activities.",
      day7: "To Alleppey: Check-in to Houseboat or Resort.",
      day8: "After breakfast, proceed to Cochin or Coimbatore drop."
    },
    inclusions: "Vehicle Cost, Parking & Toll, Driver Allowance, Interstate Permit Charges.",
    pricing: [
      { vehicle: "Swift Dzire A/C (Sedan)", price: "31,200" },
      { vehicle: "Toyota Etios A/C (Sedan)", price: "31,200" },
      { vehicle: "Innova A/C (SUV)", price: "40,540" },
      { vehicle: "Innova Crysta A/C", price: "55,500" },
      { vehicle: "Traveller A/C (14-seater)", price: "60,350" }
    ]
  },
  {
    id: "cbe-ooty-kodai-madurai-ramesh-kanya-kovalam-8d",
    route: "Coimbatore - Ooty - Kodaikanal - Madurai - Rameshwaram - Kanyakumari - Kovalam - Coimbatore",
    duration: "8 Days / 7 Nights",
    itinerary: {
      highlights: "Extended South India Pilgrimage & Beach Tour including Madurai Meenakshi Temple, Rameshwaram, Kanyakumari, and Kovalam Beach."
    },
    inclusions: "Vehicle Cost, Parking & Toll, Driver Allowance, Interstate Permit Charges.",
    pricing: [
      { vehicle: "Swift Dzire A/C (Sedan)", price: "36,250" },
      { vehicle: "Toyota Etios A/C (Sedan)", price: "36,250" },
      { vehicle: "Innova A/C (SUV)", price: "52,150" },
      { vehicle: "Innova Crysta A/C", price: "60,250" },
      { vehicle: "Traveller A/C (14-seater)", price: "64,950" }
    ]
  },
  {
    id: "cbe-ooty-kodai-munnar-alleppey-kovalam-cochin-8d",
    route: "Coimbatore - Ooty - Kodaikanal - Munnar - Alleppey - Kovalam - Cochin - Coimbatore",
    duration: "8 Days / 7 Nights",
    itinerary: {
      highlights: "Comprehensive Hills & Backwaters Tour covering the best of Tamil Nadu and Kerala including Ooty, Kodai, Munnar, Alleppey Houseboat, Kovalam, and Cochin."
    },
    inclusions: "Vehicle Cost, Parking & Toll, Driver Allowance, Interstate Permit Charges.",
    pricing: [
      { vehicle: "Swift Dzire A/C (Sedan)", price: "34,600" },
      { vehicle: "Toyota Etios A/C (Sedan)", price: "34,600" },
      { vehicle: "Innova A/C (SUV)", price: "49,950" },
      { vehicle: "Innova Crysta A/C", price: "59,000" },
      { vehicle: "Traveller A/C (14-seater)", price: "62,850" }
    ]
  }
];
